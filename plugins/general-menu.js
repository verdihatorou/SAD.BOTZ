...
try {
  pp = await conn.profilePictureUrl(who, 'image')
   ...
   conn.sendButton(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), await(await require('node-fetch')(pp)).buffer(), [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], false, { quoted: fkon, contextInfo: { externalAdReply: { showAdAttribution: true,

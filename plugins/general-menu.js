...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
   ...
   conn.sendButton(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), pp, [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], false, { quoted: fkon, contextInfo: { externalAdReply: { showAdAttribution: true,
...
conn.sendFile(m.chat, './haori.m4a', 'haori.m4a', null, fkontak, true, {
type: 'audioMessage', 
ptt: true 
})

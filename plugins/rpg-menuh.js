...
let lgocraft = `
HAI KAK SILAKAN PILIH MENU DIBAWAH`
...
const sections = [
   {
	title: "MAIN MENU",
	rows: [
	    {title: "Allmenu", rowId: ".m", description: "Crafting A Sword"},
	    {title: "Group menu", rowId: ".?gc", description: "Crafting A Pickaxe"},
